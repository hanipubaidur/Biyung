...
<head>
    ...
    <title>Biyung - Keuangan Jualan Ubi Ungu</title>
...
<body>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3">
                <div class="card bg-warning text-white">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2" id="expenseRatioLabel">Expense Ratio</h6>
                        <h3 class="card-title mb-0" id="expenseRatio">0%</h3>
                        <small id="expenseStatus" class="text-white"></small>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="employees.php" class="btn btn-sm btn-primary">View Details</a>
                    </div>
                    <div class="card-body">
                        <div class="text-center py-3">
                            <h3 class="text-primary mb-0" id="employeeCount">
                                <?php
                                $empCount = $conn->query("SELECT COUNT(*) FROM employees WHERE status='active'")->fetchColumn();
                                echo $empCount . ' Active Employees';
                                ?>
                            </h3>
    ...
    <script>
        ...
        function updateActiveEmployees(value) {
            const el = document.getElementById('activeEmployees');
            if (el) el.textContent = value;
        }
    </script>
